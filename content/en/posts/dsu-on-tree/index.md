...
date = 2024-02-16T19:05:00+08:00
tags = ["dsu-on-tree", "sack", "tree", "small-to-large"]
categories = ["Data-Structure-and-Algorithm"]
draft = false
image = "/images/icons/binarytree.png"
libraries = ["mathjax", "mermaid"]
description = "DSU on tree answers subtree queries by keeping the largest child's contribution and rebuilding only the small parts. The trick is not union-find; it is small-to-large merging hidden inside a DFS."
+++
