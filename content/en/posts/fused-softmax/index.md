...
tags = ["triton", "gpu", "softmax", "kernel-fusion", "performance"]
categories = ["AI"]
draft = false
image = "/images/posts/fused-softmax/cover.png"
libraries = ["mathjax", "chart"]
description = "how to write a fused softmax kernel in triton that eliminates redundant memory accesses and outperforms pytorch's native implementation."
+++
