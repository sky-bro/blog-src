+++
title = "Why KV Cache Works in LLM Inference"
...
libraries = ["mathjax"]
description = "why the key-value cache avoids redundant computation in autoregressive decoding, and the memory/compute tradeoffs it introduces."
+++
