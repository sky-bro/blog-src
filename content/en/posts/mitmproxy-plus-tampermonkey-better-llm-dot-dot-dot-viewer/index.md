+++
title = "Mitmproxy + Tampermonkey = better {llm, …} viewer"
date = 2026-03-22T21:49:00+08:00
tags = ["mitmproxy", "llm", "tampermonkey", "debugging"]
categories = ["proxy", "workspace-setup"]
draft = false
image = "/images/icons/better-llm-viewer.png"
libraries = ["mathjax", "mermaid"]
description = "Use mitmproxy to capture LLM API traffic and Tampermonkey to turn mitmweb's raw JSON into a readable, chat-like viewer."
+++
