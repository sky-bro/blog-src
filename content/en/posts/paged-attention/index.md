+++
title = "Paged Attention: Virtual Memory for the GPU"
date = 2026-04-22T10:00:00+08:00
tags = ["llm", "inference", "systems", "vllm", "memory"]
categories = ["AI"]
series = ["LLM Inference Internals"]
draft = false
image = "/images/posts/paged-attention/cover.svg"
libraries = ["mathjax"]
description = "How vLLM borrows the OS paging idea to eliminate KV cache memory fragmentation, pushing GPU utilization from ~30% to ~96%."
+++
