+++
title = "SSH Port Forwarding: Local and Remote Tunnels Explained"
date = 2026-04-19T00:00:00+08:00
tags = ["ssh", "networking", "linux", "devops"]
categories = ["notes"]
draft = false
image = "/images/posts/ssh-port-forwarding/ssh-cover.svg"
description = "A practical guide to SSH local and remote port forwarding, with examples, comparison, and persistent configuration via ~/.ssh/config."
+++
